...
import { listQuestions, getQuestion, createQuestion, updateQuestion, deleteQuestion, getTags, selectQuestions } from "../controllers/questions.controller.js";
...
router.post("/select", verifyToken, authorizeRoles("faculty", "admin", "superadmin"), selectQuestions);
